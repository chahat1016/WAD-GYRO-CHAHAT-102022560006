...
<div class="min-h-screen py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
            <!-- ===========================1==========================  -->
            <!-- Fill in the form action so the data can be processed in the controller admin.update with product id as parameter -->
            <form action="{{ route('admin.update', $product->id) }}" method="POST" enctype="multipart/form-data" class="p-8 sm:p-10">
                ...
                <!-- Product Name -->
                <div class="mb-8">
                    <label for="name" class="block text-sm font-semibold text-gray-900 mb-3">Product Name <span class="text-red-500">*</span></label>
                    <input type="text" name="name" id="name" value="{{ $product->name }}" placeholder="Enter product name" 
                ...
                <!-- Product Description -->
                <div class="mb-8">
                    <label for="description" class="block text-sm font-semibold text-gray-900 mb-3">Product Description <span class="text-red-500">*</span></label>
                    <textarea name="description" id="description" placeholder="Describe your product’s features, benefits, and details..." rows="6" 
                ...
                <!-- Price -->
                <div class="mb-8">
                    <label for="price" class="block text-sm font-semibold text-gray-900 mb-3">Price (Rp) <span class="text-red-500">*</span></label>
                    <div class="relative">
                ...
                <div class="mb-8 pb-8 border-b border-gray-200">
                    <h2 class="text-lg font-semibold text-gray-900 mb-6">Product Image</h2>
                    ...
                    @if($product->image)
                        <div class="mb-8">
                            ...
                            <div class="relative inline-block">
                                <img src="{{ asset('storage/' . $product->image) }}" alt="Product Image" class="w-full max-w-xs h-auto rounded-lg shadow-md border-2 border-gray-200">
                    ...
                    <!-- File Input -->
                    <div class="mb-6">
                        <p class="text-sm font-medium text-gray-700 mb-3">Update Image:</p>
                        <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-8 hover:border-blue-500 transition cursor-pointer group" onclick="document.getElementById('image').click()">
                            ...
                            <div class="text-center">
                                ...
                                <p class="mt-2 text-sm font-medium text-gray-700">Click to upload</p>
                                <p class="text-xs text-gray-500 mt-1">PNG, JPG, GIF maximum 10MB</p>
                            </div>
                        </div>
                    </div>
