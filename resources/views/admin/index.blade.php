            ...
            <div class="px-6 sm:px-10 py-8 sm:py-12">
                <div class="flex items-start justify-between">
                    <div>
                        ...
                        <p class="text-blue-100 text-lg">Manage all your products easily and efficiently</p>
                    </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
        @if($products->count() > 0)
            <div class="p-6 border-b border-gray-200">
                ...
                <p class="text-gray-600 text-sm mt-1">Manage, edit, or delete products as needed</p>
            </div>
                    ...
                    <div class="group bg-white border border-gray-200 rounded-xl hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col">
                        ...
                        <div class="p-5 flex flex-col flex-1">
                            ...
                            <div class="pt-4 border-t border-gray-100 flex gap-2">
                                ...
                                <form action="{{ route('admin.destroy', $product) }}" method="POST" class="inline-flex flex-1" onsubmit="return confirm('Delete this product permanently?')">
                                    @csrf
                                    @method('DELETE')
        ...
        @else
            ...
            <div class="px-6 py-16 text-center">
                ...
                <h3 class="text-2xl font-bold text-gray-900 mb-2">No Products</h3>
                <p class="text-gray-600 mb-6">Start adding new products to launch your business</p>
