...
<div class="min-h-screen py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-4xl font-bold text-gray-900">Create New Product</h1>
            <p class="text-gray-600 mt-2">Add a new product to your catalog with complete details</p>
        </div>

        <!-- Form Container -->
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
            <!-- ===========================1==========================  -->
            <!-- Fill in the form action so that the data can be processed in the admin.store controller -->
            <form method="POST" action="{{ route('admin.store') }}" enctype="multipart/form-data" class="p-8 sm:p-10">
                ...
                <div class="mb-8">
                    ...
                    <input type="text" name="name" id="name" placeholder="Enter an attractive product name" 
                        value="{{ old('name') }}"
                ...
                <div class="mb-8">
                    ...
                    <textarea name="description" id="description" placeholder="Describe the features, benefits, and details of your product..." rows="6" 
                ...
                <!-- Product Image -->
                <div class="mb-8">
                    <label for="image" class="block text-sm font-semibold text-gray-900 mb-3">Product Image</label>
                    ...
                    <div class="mb-4">
                        <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-8 hover:border-blue-500 transition cursor-pointer group" onclick="document.getElementById('image').click()">
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-xs text-gray-500 mt-1">PNG, JPG, GIF max 10MB</p>
                            </div>
                        </div>
                    </div>
