                    ...
                    <div class="px-6 sm:px-10 py-8 sm:py-12 flex items-center justify-between">
                        <div class="flex-1">
                            ...
                            <p class="text-blue-100 text-lg mb-4">
                                Explore the latest products and get exclusive updates from Telkom University
                            </p>
                            @if (session('status'))
                ...
                <div class="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl shadow-xl overflow-hidden">
                    <div class="px-6 sm:px-10 py-12 sm:py-16 text-center">
                        ...
                        <p class="text-blue-100 text-lg sm:text-xl mb-8 max-w-2xl mx-auto">
                            Discover quality products and read honest reviews from the Telkom University community
                        </p>
        ...
        <div class="mb-12">
            <div class="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Our newest selection of curated products</p>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    ...
                    @empty
                        <div class="col-span-full text-center py-16">
                            ...
                            <p class="text-gray-600 text-lg font-medium">No Products Yet</p>
                            <p class="text-gray-500 text-sm mt-1">Products will be added soon</p>
                        </div>
                    @endforelse
                </div>
            @else
